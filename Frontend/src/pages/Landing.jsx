...
import { Users, Building2, Clock, Calendar, TrendingUp, CheckCircle2, Shield, Zap, BarChart3, ArrowRight, Terminal, DollarSign, Cloud, HelpCircle, Settings, Heart } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: 'Comprehensive employee database with detailed profiles and organizational structure.',
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
    },
    {
      ...
      description: 'Real-time attendance monitoring with check-in/check-out functionality and detailed reports.',
    ...
    },
    {
      ...
      description: 'Streamlined leave request system with approval workflows and calendar integration.',
    ...
    },
    {
      ...
      description: 'Automated payroll calculations with salary structures, deductions, and payslip generation.',
    ...
    },
    {
      ...
      description: 'Powerful dashboard with insights, trends, and comprehensive reporting capabilities.',
      ...
      <div className="relative z-10">
        ...
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Streamline your HR operations with our comprehensive platform. Manage employees, track attendance, process payroll, and more—all in one place.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <div className="text-3xl font-bold">{stats.presentToday || 0}</div>
